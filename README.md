...
1. Ensure firewall is open for ports: 2377, 4789, 7946 e.g. `ufw allow 2377` or similar (from [here](https://www.digitalocean.com/community/tutorials/how-to-configure-the-linux-firewall-for-docker-swarm-on-centos-7)
